        ...
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-6 p-6 bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="flex-1 min-w-0 space-y-1">
              <h1 className="text-xl font-bold text-gray-900">{doctor.user?.full_name || 'Unknown Doctor'}</h1>
              ...
              <p className="text-sm text-gray-500 font-mono">{doctor.license_number}</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card title="Doctor Information">
              <div className="space-y-0">
                <div className="flex justify-between py-2.5 border-b border-gray-50">
                  ...
                  <span className="text-sm font-medium text-gray-900">{doctor.phone || 'Not provided'}</span>
                </div>
                <div className="flex justify-between py-2.5 border-b border-gray-50">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-gray-900">{doctor.user?.email || 'Not provided'}</span>
                </div>
                <div className="flex justify-between py-2.5 border-b border-gray-50">
                  <div className="flex items-center gap-2">
                ...
                <div className="flex justify-between py-2.5 border-b border-gray-50">
                  ...
                  <span className="text-sm font-medium text-gray-900 font-mono">{doctor.license_number}</span>
                </div>
                <div className="flex justify-between py-2.5">
                  ...
                  <span className="text-sm font-medium text-gray-900 max-w-[200px] text-right">{doctor.bio || 'No bio provided'}</span>
                </div>
              </div>
            </Card>
            ...
            <Card title="Availability Schedule">
              <div className="space-y-4">
                <div>
                  <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider block mb-2">Available Days</span>
                ...
                <div className="pt-3 border-t border-gray-100">
                  <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider block mb-2">Working Hours</span>
